...
path=/Users/bperez/ownCloud/Recherche/Stages/Stage_M1/results_2019_100/
path_script=/Users/bperez/ownCloud/Recherche/Stages/Stage_M1/results_2019_100/script/
...
$path_usearch -unoise3 $path/trait/reads_16s_sorted.fa -zotus $path/trait/reads_16s_OTU_clean.fa -minsize 4
...
#echo "Taxonomy:"
source activate qiime1
assign_taxonomy.py -i $path/trait/16s_OTU.fa -o $path/trait/ -r /Users/bperez/ownCloud/Recherche/Stages/Stage_M1/results_2017_99/database/99_otus.fasta -t /Users/bperez/ownCloud/Recherche/Stages/Stage_M1/results_2017_99/database/99_otu_taxonomy.txt
